...
<!-- wp:column {"verticalAlignment":"bottom","width":"33.3%","style":{"spacing":{"margin":{"bottom":"0","top":"var:preset|spacing|md"}},"\u002d\u002dposition":"relative"}} -->
...
<p class="has-sans-serif-font-family" style="padding-bottom:var(--wp--preset--spacing--xxs)">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod dolor</p>
<!-- /wp:paragraph -->
...
<p class="aligncenter has-text-align-center aligncenter" style="padding-top:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--sm)">© Copyright [year] Lightwork  <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-foreground-color">⚡️</mark> by Blockify. All rights reserved. </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->