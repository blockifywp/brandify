 ...
 */
?>
<!-- wp:group {"align":"full","style":{"\u002d\u002dmarquee-speed-mobile":"50s","\u002d\u002dmarquee-speed-desktop":"80s","\u002d\u002dmarquee-direction":"forwards","\u002d\u002dmarquee-pause":"paused","spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"0"},"typography":{"fontStyle":"normal","fontWeight":"600"}},"backgroundColor":"primary","className":"is-style-dark","layout":{"type":"flex","flexWrap":"nowrap","orientation":"marquee","justifyContent":"spaceBetween"},"speedMobile":"50","speedDesktop":"80","reverse":false,"pauseOnHover":true,"repeatItems":2} -->
<div class="wp-block-group alignfull is-style-dark has-primary-background-color has-background" style="margin-top:0;margin-bottom:0;font-style:normal;font-weight:600;--marquee-speed-mobile:50s;--marquee-speed-desktop:80s;--marquee-direction:forwards;--marquee-pause:paused"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|sm","right":"0","bottom":"var:preset|spacing|sm","left":"0"}}},"fontSize":"large"} -->
<p class="has-large-font-size" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--sm);padding-right:0;padding-bottom:var(--wp--preset--spacing--sm);padding-left:0">Contact Us ⋆ Start Your Project ⋆ Get in Touch ⋆ Launch Your Idea ⋆ Work With Us ⋆ Let's Talk ⋆ Begin Your Journey ⋆ Grow Your Business ⋆ Ask a Question ⋆ Get Support ⋆ Learn More ⋆ Build Your Brand ⋆</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg","right":"0","left":"0"},"margin":{"top":"0"}}},"className":"is-style-dark","layout":{"type":"constrained"}} -->
